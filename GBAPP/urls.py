...
urlpatterns = [
    ...
    path('fraccionado_detail/<int:orden_id>/', views.fraccionado_detail, name='fraccionado_deatil'),
    path('fraccionado_update/<int:orden_id>', views.fraccionado_update, name='fraccionado_update'),
